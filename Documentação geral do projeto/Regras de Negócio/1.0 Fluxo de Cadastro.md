...
### 📋 Validações do formulário (Paciente)
...
### 📋 Validações do formulário (Profissional)
...
👉 Quer que eu também crie uma **tabela de validações consolidada** (Paciente vs Profissional) para facilitar a consulta rápida no repositório, como referência para QA e Dev?
